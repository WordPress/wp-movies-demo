...
$moviesDom->load("wp_sampledata_movies.xml");
...
$actorsDom->load("wp_sampledata_actors.xml");
...
$mediaDom->load("wp_sampledata_media.xml");
...
$mediaDom->save('wp_sampledata_media.xml');
